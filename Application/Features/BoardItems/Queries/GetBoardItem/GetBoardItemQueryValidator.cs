...
public class GetBoardItemQueryValidator : AbstractValidator<GetBoardItemQuery>
{
    private readonly IMoodBoardDbContext _context;
    private readonly ILoggedInUserService _loggedInUserService;
    private Guid _boardItemId;

    public GetBoardItemQueryValidator(IMoodBoardDbContext context, ILoggedInUserService loggedInUserService)
    {
        _context = context;
